...
public class DecisionLeafBaseTest {
    ...
    public void testExpandThis() {
        ...
        Assert.assertEquals("div4", root2.toString());
        ...
        Assert.assertEquals(0x01 + (nYears - 0x01) / 4, CollectionUtils.size(leaft.getStoredSources()));
        Assert.assertEquals(nYears - 0x01 - (nYears - 0x01) / 4, CollectionUtils.size(leaff.getStoredSources()));
        Assert.assertEquals(nYears, CollectionUtils.size(root.getStoredSources()));

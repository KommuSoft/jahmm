 ...
 */
public class InvariantHmmDotDrawer extends HmmDotDrawer<RegularHmmBase<?>> {

    public static final InvariantHmmDotDrawer Instance = new InvariantHmmDotDrawer();

    private InvariantHmmDotDrawer() {
    }

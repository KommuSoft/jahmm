...
public interface Centroid<O> {
     ...
     * centroid of the observations composing <code>v</code> and that we want it
     * to be the centroid of <code>v</code> plus the value of the observation
     * <code>e</code>.
     *
     * @param e An observation that must be involved in the computation of the
     * new value of this centroid.
     ...
     * Reevalue the value of this centroid, knowing that it currently is the
     * centroid of the observations composing <code>v</code> and that we want it
     * to be the centroid of <code>v</code> minus the value of the observation
     * <code>e</code>.
     *
     * @param e An observation that must not be involved in the computation of
     * the new value of this centroid.

 ...
 * the n-th state. A state description begins with the keywords
 * <tt>State</tt> and </tt>Pi</tt>, followed by the initial probability of this
 * state. Then comes the letter <tt>A</tt> followed by the state transition
 * probabilities separated by a space, in the right order. Then comes a
 * description of an observation distribution which depends on the type of
 * observation handled by the HMM.
 * <p>
 ...
 * A 0.4 0.6
 * IntegerOPDF [ .1 .1 .1 .7 ]
 * </pre> The lines starting with 'IntegerOPDF' are distributions descriptions.
 */

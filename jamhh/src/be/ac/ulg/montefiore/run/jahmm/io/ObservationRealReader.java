 ...
 * <p>
 * The format of this observation is a simple real number (following the format
 * [+-]?[0123456789]+[.]?[0123456789]*, <i>e.g.</i>
 * 12.3).
 * <p>
 * For example, reading
 * <pre>76.3;</pre> creates an observation such as the one generated by
